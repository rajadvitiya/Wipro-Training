...
def driver():
    ...
    driver.get("https://the-internet.herokuapp.com/windows")  # ✅ fixed URL
    yield driver
    driver.quit()
...
#     assert  header == 'New Window', 'New switch did not happen'
#
#     time.sleep(3)
#     driver.close()
...
def test_open_multiple_tabs(driver):
    ...
    assert len(handles)  == 4, 'Multiple Windows not open'
